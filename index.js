...
class Car {
  ...
  drive(distance) {
    // Created a variable to give total miles a car can drive
    ...
    //created variable to remove gas from tank with distance
    const gallonRemoval = distance / 
    this.milesPerGallon;
    this.tank = this.tank - gallonRemoval;
